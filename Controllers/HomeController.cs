...
namespace ContosoTeamStats.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult RedisCache()
        {
            ...
            ViewBag.CommandResult = cache.Execute(ViewBag.command1).ToString();
        ...
        /// NOTES:
        ///     1. Users of the ConnectionMultiplexer MUST handle ObjectDisposedExceptions, 
        ///         which can now happen as a result of calling ForceReconnect().
